...
public class BlahajBlocks {
	...
	public static void register() {
		...
		BLAVINGAD_ITEM = Registry.register(Registries.ITEM, BLAVINGAD_ID, new CuddlyItem(BLAVINGAD_BLOCK, new Item.Settings().maxCount(1), "block.blahaj.blue_whale.tooltip"));
		BREAD_ITEM = Registry.register(Registries.ITEM, BREAD_ID, new CuddlyItem(BREAD_BLOCK, new Item.Settings().maxCount(1), null));
		BROWN_BEAR_ITEM = Registry.register(Registries.ITEM, BROWN_BEAR_ID, new CuddlyItem(BROWN_BEAR_BLOCK, new Item.Settings().maxCount(1), "block.blahaj.brown_bear.tooltip"));
		...
		for (String name : PRIDE_NAMES) {
			...
			Item item = Registry.register(Registries.ITEM, id, new CuddlyItem(block, new Item.Settings().maxCount(1), "block.blahaj.blue_shark.tooltip"));
